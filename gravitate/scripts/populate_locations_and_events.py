...
if __name__ == "__main__":
    ...
    # populate_airport_events.populate_events(start_string="2019-03-23T08:00:00.000",
    #                                         num_days=10, event_category="campus")
    #
    # Populate database for airport location and events
    populate_locations.doWork()
    populate_airport_events.populate_events(start_string="2020-04-22T08:00:00.000", num_days=90)
