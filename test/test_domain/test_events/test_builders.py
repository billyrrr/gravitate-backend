...
class EventNewBuilderTest(TestCase):
    ...
    def testBuildDict(self):
        ...
        b.build_airport("LAX")
        b.build_basic_info()
        b.build_target(to_event=True, start_timestamp=1545033600, end_timestamp=1545119999)
        b.build_target(to_event=False, start_timestamp=1545033600, end_timestamp=1545119999)
        b.build_descriptions("what the event is", "name of the event")
        b.build_parking()
        b.build_local_date_string("2018-12-17")
